...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1779.689940128744; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3561.4915429854805; // x position of the perpendicular encoder (in tick units)
    }
